...
// ─── Stubs ───────────────────────────────────────────────────
export async function parseExcelFile(_fileBuffer: ArrayBuffer): Promise<DashboardData | null> {
...
export async function syncFromRemotePath(
  ...
  return { data: null, error: "Remote file sync not yet enabled for this deployment." };
}
...
export function calculateTotals(data: {
  ...
  const tradingIO = data.tradingIOData.reduce(
    ...
    {
      tranchenMB3PY: 0, tranchenNNPY: 0,
      tranchenMB3CY: 0, tranchenNNCY: 0,
      planMB3: 0, planNN: 0,
      istMB3: 0, istNN: 0,
    }
  );
  ...
  return {
    ...
    tradingIO: {
      ...tradingIO,
      tranchenPFPY: tradingIO.tranchenMB3PY > 0 ? tradingIO.tranchenNNPY / tradingIO.tranchenMB3PY : 0,
      tranchenPFCY: tradingIO.tranchenMB3CY > 0 ? tradingIO.tranchenNNCY / tradingIO.tranchenMB3CY : 0,
      pacingMB3: tradingIO.planMB3 > 0 ? tradingIO.istMB3 / tradingIO.planMB3 : 0,
